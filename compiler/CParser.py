...
class CParser ( Parser ):
    ...
    class GotoGCCStatementContext(ParserRuleContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterGotoGCCStatement" ):
                listener.enterGotoGCCStatement(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitGotoGCCStatement" ):
                listener.exitGotoGCCStatement(self)
